  ...
  return (
    <>
      ...
      <SettingsSection title="Retry rules" description="No Answer schedules attempts 1 and 2; the third unanswered attempt moves the lead to Finished as Unreachable.">
        <SettingsRow title="Cold no-answer retry" description="Attempts 1 and 2 always create a visible Retry action for the next configured calling day."><Badge tone="info">Next calling day</Badge></SettingsRow>
        <SettingsRow title="Warm follow-up retry delay" description="Delay after a No Answer on an already-engaged follow-up."><NumberInput value={calling.defaultRetryDelayBusinessDays} min={1} onChange={(defaultRetryDelayBusinessDays) => update({ defaultRetryDelayBusinessDays })} suffix="business days" /></SettingsRow>
