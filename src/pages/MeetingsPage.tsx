...
export function MeetingsPage() {
  ...
  return <>
    ...
    <section className="panel meetings-panel">
      ...
      })}</div> : <EmptyState icon={<Icon name="calendar" size={28} />} title={`No ${tab.replace("_", " ")} meetings`} description={tab === "today" ? "Meetings scheduled for today appear here with the full calling context." : "Meeting records move here automatically as their status changes."} />}
    </section>
